...
Observação: o GIF não está incluído no repositório por padrão. Se você gerar `public/demo.gif` localmente (instruções acima) e commitar, o README passará a exibir o GIF automaticamente.
